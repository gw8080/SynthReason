...
void data1() {
  ...
  for (int i = stagebegin; i < ((spectrumFeed.length-1)/(4))*stageend; i++)
  {
    ...
    outputz.println(i + "/" + ((spectrumFeed.length-1)/(4))*1);
    outputz.close();
    String spectrumx = "";
...
void data2() {
  ...
  for (int i = ((spectrumFeed.length-1)/(4))*stagebegin; i < ((spectrumFeed.length-1)/(4))*stageend; i++)
  {
    ...
    outputz2.println(i + "/" + ((spectrumFeed.length-1)/(4))*1);
    outputz2.close();
    String spectrumx = "";
    String[] knowledge = loadResourcesA("text.txt");
    for (int i2 = 0; i2 != spectrumFeed.length-1; i2++)
...
void data3() {
  ...
  for (int i = ((spectrumFeed.length-1)/(4))*stagebegin; i < ((spectrumFeed.length-1)/(4))*stageend; i++)
  {
    ...
    outputz3.println(i + "/" + ((spectrumFeed.length-1)/(4))*1);
    outputz3.close();
    String spectrumx = "";
    String[] knowledge = loadResourcesA("text.txt");
    for (int i2 = 0; i2 != spectrumFeed.length-1; i2++)
...
void data4() {
  ...
  for (int i = ((spectrumFeed.length-1)/(4))*stagebegin; i < ((spectrumFeed.length-1)/(4))*stageend; i++)
  {
    ...
    outputz4.println(i + "/" + ((spectrumFeed.length-1)/(4))*1);
    outputz4.close();
    String spectrumx = "";
    String[] knowledge = loadResourcesA("text.txt");
    for (int i2 = 0; i2 != spectrumFeed.length-1; i2++)
